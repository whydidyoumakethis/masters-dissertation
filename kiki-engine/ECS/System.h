...
public:
    ...
    void OnStart() override {
        std::cout << "Starting input system" << std::endl;
    ...
    void OnUpdate(float dt) override {
        ...
        if (inputManager.isMouseButtonJustDown(GLFW_MOUSE_BUTTON_RIGHT)) {
            std::cout << "Right click was just pressed" << std::endl;
        }
            ...
            std::cout << "Right click was just released" << std::endl;
        }

    ...
    void InterfaceSystem::OnUpdate(float dt) {
        ...
        for (auto [e, interfaceComponent] : uiComponents.each()) {
            if (interfaceComponent.dirty) {
                ...
                interfaceComponent.position.absoluteX = (extent.width * interfaceComponent.position.scaleX) + interfaceComponent.position.x;
                interfaceComponent.position.absoluteY = (extent.height * interfaceComponent.position.scaleY) + interfaceComponent.position.y;

                interfaceComponent.size.absoluteX = (extent.width * interfaceComponent.size.scaleX) + interfaceComponent.size.x;
                interfaceComponent.size.absoluteY = (extent.height * interfaceComponent.size.scaleY) + interfaceComponent.size.y;
